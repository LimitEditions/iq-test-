    ...
    <div class="question">
      ...
      <div class="question-img">
        <img
          ...
          :key="choose.id"
          :class="{
            'question-choose-img': true,
            'selected-img': selectedGender === choose.img,
          }"
          :src="choose.img"
          :alt="choose.img"
          @click="selectedGender = choose.img"
        />
      </div>
...
import img9 from "@/assets/img/Rectangle9.png";
